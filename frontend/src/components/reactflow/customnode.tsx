  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        ...
        {true && !isPlaceholderLabel(data.label) && (
          <div className="bg-teal-50/50 rounded-lg p-3 border border-teal-200 hover:bg-teal-50 transition-all duration-200">
            <div className="flex items-center gap-2 text-xs font-medium text-teal-600 mb-2">
              <svg
                className="w-3 h-3"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <div className="text-sm text-gray-600 break-words max-h-[100px] overflow-y-auto scrollbar-thin scrollbar-thumb-teal-200 scrollbar-track-transparent">
              {"A long prompt that is generated by the AI"}
            </div>
          </div>
        )}
      </div>
